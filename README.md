...
Much of the math and the programming syntax was familiar. What was great about this course, for me, was application of math problems, combinations and permutations for example, to real life examples through programming. This is the first time I used matplotlib and plotting tools in Python. Check out some of my plots in [week 2.] 
(https://github.com/ElAwbery/MIT-6.00.2x/blob/master/Week%202/linear_comparisons.png) 
